...
def Proj_DBScan(conj_puntos, eps, MinPts, metadata=None):
    ...
    conj_puntos = sorted(conj_puntos, key=operator.attrgetter('X'))
...
if __name__ == "__main__":
    ...
    resultado = Proj_DBScan(conjunto_de_puntos, 2, 2)
